...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (!container) {
    console.error("ID cardGlass ga ketemu! ❌");
    return;
  }
  ...
  function createPaw() {
    ...
    // Ambil ukuran container secara real-time
    const rect = container.getBoundingClientRect();
    
    // Spread merata di seluruh area lebar dan tinggi container
    ...
    // Rotasi acak 360 derajat biar lebih natural
  ...
  // Munculkan jejak kaki setiap 400ms
